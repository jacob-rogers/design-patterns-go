...
func (b *BankAccount) Withdraw(amount int) bool {
	...
	fmt.Println("Cannot withdraw", amount, "\b, maximum withdraw amount is", b.balance-overdraftLimit)
	return false
}
...
func main() {
	...
	// to := BankAccount{0}
	// fmt.Println("Initial balance:", from, to)
	// mtc := NewMoneyTransferCommand(&from, &to, 25)
	// mtc.Call()
	// fmt.Println("Post-transfer balance:", from, to)

	// mtc.Undo()
	// fmt.Println("Trasfer rejected balance:", from, to)
